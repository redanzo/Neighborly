    ...
    return (
        <div className="auth-container fade-in">
            ...
            <form onSubmit={step === 1 ? handleContinue : handleSignup} className="auth-form signup-form">
                ...
                {step === 2 && (
                    <>
                        <div className="dropdown-container custom-dropdown" onClick={() => setDropdownOpen(prev => !prev)}>
                            <img src="/img/search.png" alt="Search Icon" className="search-icon" />
                            <div className="selected-value">{formData.community || 'Select Community'}</div>
                            {dropdownOpen && (
                        ...
                        {formData.community && (
                            <>
                                <input name="line1" placeholder="Address Line 1" value={formData.address.line1} onChange={handleChange} />
                                <input name="line2" placeholder="Address Line 2" value={formData.address.line2} onChange={handleChange} />
                                <input name="city" placeholder="City" value={formData.address.city} onChange={handleChange} />
                                <input name="state" placeholder="State" value={formData.address.state} onChange={handleChange} />
                                <input name="zip" placeholder="ZIP Code" value={formData.address.zip} onChange={handleChange} />
                ...
                <p className="switch-link" onClick={() => switchPage('Login')}>
